      ...
      slicedData.forEach(post => {
          ...
          postDiv.innerHTML = `
              ...
              <div class="w-full h-72 mb-4">
                <img class="block transform group-hover:scale-105 transition duration-200 ease-in-out w-full h-full object-cover object-center" src="${post.image}" alt="${post.title}">
              </div>
              <h3 class="text-xl font-bold mb-4">${post.title}</h3>
              <p class="inline-block mb-12 lg:mb-4 text-base font-semibold text-ke-blue py-2 w-full md:w-auto rounded hover:scale-105 focus:scale-105 transition duration-200 ease-in-out">Read More</p>
              </a>
          `;
